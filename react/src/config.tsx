...
export const taxYearsCategories = [
  {
    id: '1',
    from: new Date('1975-04-05'),
    to: new Date('1976-04-05'),
    categories: ['A','B','C']
  },
  {
    id: '2',
    from: new Date('1976-04-05'),
    to: new Date('1977-04-05'),
    categories: ['A','B','C']
  },
  {
    id: '3',
    from: new Date('1977-04-05'),
    to: new Date('1978-04-05'),
    categories: ['A','B','C']
  },
  {
    id: '4',
    from: new Date('1978-04-05'),
  ...
  {
    id: '6',
    from: new Date('1979-04-05'),
    to: new Date('1980-04-05'),
    categories: ['A','B','C','D','E']
  },
  {
    id: '7',
    from: new Date('1980-04-05'),
    to: new Date('1981-04-05'),
    categories: ['A','B','C','D','E']
  },
  {
    id: '8',
    from: new Date('1981-04-05'),
    to: new Date('1982-04-05'),
    categories: ['A','B','C','D','E']
  },
  {
    id: '9',
    from: new Date('1982-04-05'),
  ...
  {
    id: '17',
    from: new Date('1986-04-05'),
    to: new Date('1987-04-05'),
    categories: ['A','B','C','D','E']
  },
  {
    id: '18',
    from: new Date('1987-04-05'),
    to: new Date('1988-04-05'),
    categories: ['A','B','C','D','E']
  },
  {
    id: '19',
    from: new Date('1988-04-05'),
    to: new Date('1989-04-05'),
    categories: ['A','B','C','D','E']
  },
  {
    id: '20',
    from: new Date('1989-04-05'),
